 ...
 * Warns the user that all associated data will be removed (cascade delete).
 */
...
export function DeleteProjectDialog({ project, onClose }: DeleteProjectDialogProps) {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      logger.error("DeleteProjectDialog", "Failed to delete project", { error: String(err) });
    }
  };
        ...
        >
          ...
          <div className="px-5 py-4 flex flex-col gap-4">
            ...
            <p className="text-xs text-muted-foreground">
              This will permanently remove the project and all associated agents, resources, MCP
              servers, and skills. This action cannot be undone.
            </p>
